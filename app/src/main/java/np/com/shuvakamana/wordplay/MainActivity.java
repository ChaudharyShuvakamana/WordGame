package np.com.shuvakamana.wordplay;
...
import np.com.shuvakamana.wordplay.adapters.CharactersAdapter;

public class MainActivity extends AppCompatActivity implements View.OnClickListener {

    private String[] words = {"apple", "ball", "software", "enlightment", "sun", "moon"};
